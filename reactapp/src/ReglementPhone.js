...
class ReglementPhone extends Component {
    render() {
        return(
            <>
            <div className="ReglementComponentPhone">
                <h1>Reglement</h1>
                ...
                <ol>
                    ...
                    <ol>
                        ...
                        <li type="a">Wenn während des Turnires extreme Platz- oder Wetterverhältnisse herrschen, kann das OK das Turnier unterbrechen oder abbrechen. Genauere Informationen dazu werden in diesem Fall am Speakertisch bekannt gegeben.</li>
                    </ol>
                    <h3>
                ...
                <ol>
                    ...
                    <ol>
                        <li type="a">Teilnahmeberechtigt sind alle studierenden und mitarbeienden der FHNW Muttenz.</li>
                ...
                <ol>
                    ...
                    <ol>
                        <li type="a">Zu spät oder nichtantretende Mannschaften verlieren das betreffende Spiel mit 0:3 forfait.</li>
                    </ol>
                    <h3>
                        <li type="1">Preise</li>
                    </h3>
                    ...
                    <ol>
                        <li type="a">Jedes Team muss einen Schiedsrichter stellen. Dieser pfeifft nur Spiele, welche seine Gruppe nicht betreffen.</li>
                    </ol>
                </ol>
            </div>
            </>
