...
export default function UPSPhone() {
    return (
        <div className='DankeComponentPhone'>
            <div className='DankeWrapperPhone'>
                <h1>Ups...</h1>
                <p>Das hat nicht funktioniert, versuche es später erneut oder kontaktiere uns per <a className='GesuchAuswertige' href='mailto: fabian.ruefenacht@students.fhnw.ch'>Mail</a>.</p>
                <svg version="1.1" id="Layer_1" x="0px" y="0px" width={'50px'} viewBox="0 0 122.88 122.879" enable-background="new 0 0 122.88 122.879">
                    <g>
