...
class FooterPhone extends Component {
    ...
    render() {
        return (
            <div className="FooterPhone Footer">
                ...
                {this.state.Impressum &&
                    <div className="FooterImpressumPhone FooterImpressum">
                        <div>
                            <h3>Kontakt</h3>
                ...
                {this.state.Datenschutz &&
                    <div className="FooterDatenschutzPhone FooterDatenschutz">
                        <h3>Datenschutz</h3>
                        ...
                        <h3>Haftungsausschluss</h3>
                        <p>Für das Webhosting unserer Webseiten wurden uns die Hosting-Dienstleistungen der FHNW bereitgestellt. Der Serverstandort liegt in der Schweiz.</p>
                        <h3>Cookies</h3>
